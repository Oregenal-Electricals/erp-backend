...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        ...
        HealthController_1.prototype.check = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.healthCheck()];
                        case 1:
                            dbStatus = _a.sent();
                            return [2 /*return*/, {
        ...
        HealthController_1.prototype.ping = function () {
            return {
                status: 'ok',
        ...
        HealthController_1.prototype.dbCheck = function () {
            return __awaiter(this, void 0, void 0, function () {
                var isConnected;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Basic health check' })];
        _ping_decorators = [(0, common_1.Get)('ping'), (0, swagger_1.ApiOperation)({ summary: 'Simple ping check' })];
        _dbCheck_decorators = [(0, common_1.Get)('db'), (0, swagger_1.ApiOperation)({ summary: 'Database connectivity check' })];
        ...
        __esDecorate(_classThis, null, _dbCheck_decorators, { kind: "method", name: "dbCheck", static: false, private: false, access: { has: function (obj) { return "dbCheck" in obj; }, get: function (obj) { return obj.dbCheck; } }, metadata: _metadata }, null, _instanceExtraInitializers);
