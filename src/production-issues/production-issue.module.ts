...
@Module({
  imports: [PrismaModule, CommonModule, StockLedgerModule, MrpModule, ProductionMaterialReturnModule, MaterialIssueOverrideModule, WorkOrderModule, AdditionalMaterialRequestModule, StockLocationBalanceModule],
