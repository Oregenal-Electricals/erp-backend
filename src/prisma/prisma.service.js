                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$queryRaw(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      SELECT tablename FROM pg_tables WHERE schemaname='public'\n    "], ["\n      SELECT tablename FROM pg_tables WHERE schemaname='public'\n    "])))];
                        case 1:
                            tablenames = _a.sent();
                        ...
                        case 2:
                            ...
                            tablename = tablenames_1[_i].tablename;
                            if (!(tablename !== '_prisma_migrations')) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.$executeRawUnsafe("TRUNCATE TABLE \"".concat(tablename, "\" CASCADE;"))];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        case 4:
