...
var AuthController = function () {
        ...
        AuthController_1.prototype.login = function (dto, req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    return [2 /*return*/, this.authService.login(dto, ip)];
                });
            });
        };
        AuthController_1.prototype.me = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.me(user.id)];
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Login and get JWT token' })];
        _me_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Get current user profile' })];
