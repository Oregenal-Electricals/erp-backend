-- ============================================================
-- IQC Checklist Templates + Multi-Stage Escalation (full - for
-- environments that never got the corrected partial run)
-- ============================================================
...
ALTER TABLE iqc_inspections ADD COLUMN "lotQuantity" DOUBLE PRECISION;
ALTER TABLE iqc_inspections ADD COLUMN "sampleSize" INTEGER;
ALTER TABLE iqc_inspections ADD COLUMN "mrirNo" TEXT;
ALTER TABLE iqc_inspections ADD COLUMN "supplierName" TEXT;
ALTER TABLE iqc_inspections ADD COLUMN "currentStage" TEXT NOT NULL DEFAULT 'IQC';
ALTER TABLE iqc_inspections ADD COLUMN "finalOutcome" TEXT NOT NULL DEFAULT 'PENDING';
...
ALTER TABLE rejected_stock_items ADD COLUMN "vendorPickupDeadline" TIMESTAMP;
ALTER TABLE rejected_stock_items ADD COLUMN "vendorNotifiedAt" TIMESTAMP;
ALTER TABLE rejected_stock_items ADD COLUMN "disposalEligible" BOOLEAN NOT NULL DEFAULT false;
