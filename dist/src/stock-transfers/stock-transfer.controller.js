...
let StockTransferController = class StockTransferController {
    constructor(stService) {
        this.stService = stService;
    }
    getStats(req) { return this.stService.getStats(req.user); }
    findAll(req, query) { return this.stService.findAll(req.user, query); }
    findOne(id, req) { return this.stService.findOne(id, req.user); }
    create(dto, req) { return this.stService.create(dto, req.user); }
    confirm(id, req) { return this.stService.confirm(id, req.user); }
    cancel(id, req) { return this.stService.cancel(id, req.user); }
};
...
__decorate([
    ...
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [stock_transfer_dto_1.CreateTransferDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], StockTransferController.prototype, "confirm", null);
__decorate([
