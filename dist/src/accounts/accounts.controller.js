...
let AccountsController = class AccountsController {
    ...
    getStats(req) { return this.accountsService.getStats(req.user); }
    getTree(req) { return this.accountsService.getTree(req.user); }
    seed(req) { return this.accountsService.seedDefaultAccounts(req.user.companyId, req.user.id); }
    findAll(req, query) { return this.accountsService.findAll(req.user, query); }
    findOne(id, req) { return this.accountsService.findOne(id, req.user); }
    create(dto, req) { return this.accountsService.create(dto, req.user); }
    update(id, dto, req) { return this.accountsService.update(id, dto, req.user); }
};
...
], AccountsController.prototype, "getStats", null);
__decorate([
    (0, common_1.Get)('tree'),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.FINANCE_VIEW),
    __param(0, (0, common_1.Request)()),
