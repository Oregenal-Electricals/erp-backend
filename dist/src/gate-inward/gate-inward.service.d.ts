...
export declare class GateInwardService {
    ...
    flagNoPoReference(id: string, reason: string, user: any): Promise<{
        items: {
            id: string;
            companyId: string;
            isActive: boolean;
    ...
    private notifyOfNoPoReferenceHold;
    private assertOnNoPoReferenceHold;
    resolveNoPoReferenceApproved(id: string, reason: string, user: any): Promise<{
        items: {
            id: string;
            companyId: string;
            isActive: boolean;
    ...
    resolveNoPoReferenceRejected(id: string, reason: string, user: any): Promise<{
        items: {
            id: string;
            companyId: string;
            isActive: boolean;
