...
let OqcController = class OqcController {
    ...
    getPendingFgReceipts(req) { return this.oqcService.getPendingFgReceipts(req.user); }
...
__decorate([
    (0, common_1.Get)('pending-fg-receipts'),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.OQC_VIEW),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], OqcController.prototype, "getPendingFgReceipts", null);
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.OQC_VIEW),
    __param(0, (0, common_1.Request)()),
