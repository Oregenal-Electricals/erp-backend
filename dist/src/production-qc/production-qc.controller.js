...
exports.ProductionQcController = void 0;
const common_1 = require("@nestjs/common");
const production_qc_service_1 = require("./production-qc.service");
const production_qc_dto_1 = require("./dto/production-qc.dto");
const jwt_auth_guard_1 = require("../common/guards/jwt-auth.guard");
const permissions_guard_1 = require("../common/guards/permissions.guard");
const permissions_decorator_1 = require("../common/decorators/permissions.decorator");
const permissions_enum_1 = require("../common/permissions/permissions.enum");
let ProductionQcController = class ProductionQcController {
    constructor(pqcService) {
        this.pqcService = pqcService;
    }
    getStats(req) { return this.pqcService.getStats(req.user); }
    findAll(req, query) { return this.pqcService.findAll(req.user, query); }
...
], ProductionQcController.prototype, "getStats", null);
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.PRODUCTION_QC_VIEW),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], ProductionQcController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.QUALITY_VIEW),
    ...
    __metadata("design:returntype", void 0)
], ProductionQcController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [production_qc_dto_1.CreateProductionQcDto, Object]),
    __metadata("design:returntype", void 0)
], ProductionQcController.prototype, "create", null);
__decorate([
...
exports.ProductionQcController = ProductionQcController = __decorate([
    ...
    __metadata("design:paramtypes", [production_qc_service_1.ProductionQcService])
], ProductionQcController);
//# sourceMappingURL=production-qc.controller.js.map