...
const capa_dto_1 = require("./dto/capa.dto");
...
let CapaController = class CapaController {
    ...
    getStats(req) { return this.capaService.getStats(req.user); }
    findAll(req, query) { return this.capaService.findAll(req.user, query); }
    findOne(id, req) { return this.capaService.findOne(id, req.user); }
    create(dto, req) { return this.capaService.create(dto, req.user); }
    update(id, dto, req) { return this.capaService.update(id, dto, req.user); }
    verify(id, dto, req) { return this.capaService.verify(id, dto, req.user); }
};
...
], CapaController.prototype, "getStats", null);
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.QUALITY_VIEW),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [capa_dto_1.CreateCapaDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, capa_dto_1.UpdateCapaDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, capa_dto_1.VerifyCapaDto, Object]),
    __metadata("design:returntype", void 0)
], CapaController.prototype, "verify", null);
