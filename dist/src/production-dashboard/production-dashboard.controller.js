...
let ProductionDashboardController = class ProductionDashboardController {
    ...
    getHourlyMonitoring(req, date) { return this.pdService.getHourlyMonitoring(req.user, date); }
};
...
__decorate([
    (0, common_1.Get)('hourly-monitoring'),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.Permission.PRODUCTION_VIEW),
    __param(0, (0, common_1.Request)()),
    ...
    __metadata("design:returntype", void 0)
], ProductionDashboardController.prototype, "getHourlyMonitoring", null);
