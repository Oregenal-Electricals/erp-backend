...
exports.ProductionIssueModule = ProductionIssueModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, common_module_1.CommonModule, stock_ledger_module_1.StockLedgerModule, mrp_module_1.MrpModule, production_material_return_module_1.ProductionMaterialReturnModule, material_issue_override_module_1.MaterialIssueOverrideModule, work_order_module_1.WorkOrderModule, additional_material_request_module_1.AdditionalMaterialRequestModule, stock_location_balance_module_1.StockLocationBalanceModule],
